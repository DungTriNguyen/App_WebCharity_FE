...
const SummarySection = () => {
  const summaryItems = [
    {
      title: 'Tầm nhìn',
      content:
        '"Trở thành cầu nối vững chắc giữa cộng đồng và những hoàn cảnh khó khăn, lan tỏa tinh thần nhân ái trong sinh viên và xã hội".',
      icon: (
        <svg
          width='62'
          height='50'
    ...
    },
    {
      title: 'Sứ mệnh',
      content:
        '"Kết nối - Hỗ trợ - Lan tỏa yêu thương thông qua các hoạt động thiện nguyện, quyên góp và tình nguyện vì cộng đồng"',
      icon: (
        <svg
          width='55'
          height='55'
    ...
    },
    {
      ...
      content:
        '"Tận tâm trong hành động, minh bạch trong quản lý, kết nối cộng đồng, hướng đến phát triển bền vững."',
      icon: (
        <svg
          width='50'
          height='50'
  ...
  return (
    <div className='bg-[#EDEDED] py-8'>
      ...
      <Separator className='w-[125px] h-[2px] bg-[#0BAEFF] m-auto' />
      <p className='text-center mt-6 mb-6 container 2xl:max-w-[1200px] mx-auto'>
        "SGU Charity là tổ chức từ thiện trực thuộc Trường Đại học Sài Gòn, được
        thành lập với sứ mệnh kết nối cộng đồng, lan tỏa yêu thương và giúp đỡ
        những hoàn cảnh khó khăn. Chúng tôi tổ chức các chương trình quyên góp,
        hỗ trợ tài chính, vật phẩm thiết yếu cũng như tìm kiếm tình nguyện viên
        để tham gia các hoạt động thiện nguyện như phát cơm cho người vô gia cư,
        hỗ trợ trẻ em vùng sâu vùng xa, và các chiến dịch bảo vệ môi trường"
      </p>
      <ul className='flex justify-around mt-4'>
        {summaryItems.map((item) => (
          ...
          >
            ...
            <em className='text-center mt-2'>{item.content}</em>
          </li>
        ))}
      </ul>
    </div>
